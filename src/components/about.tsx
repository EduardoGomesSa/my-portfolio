export function About() {
    return (
        <div>
            ...
            <p>Sobre mim</p>
            <p>Eu sou um aficcionado por desenvolvimento de software e tecnologia. Sempre em busca de novos desefios </p>
            ...
            <button className="bg-[#8A42DB] text-white py-2 px-4 rounded hover:bg-blue-700">
                Meu currículo
            </button>
        </div>
    )
